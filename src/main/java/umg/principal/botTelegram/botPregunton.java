...
public class botPregunton extends TelegramLongPollingBot {
    ...
    public botPregunton() {
        ...
        preguntas.put("SECTION_4", new String[]{"Pregunta 4.1 - Donde estudias? ", "Pregunta 4.2 - cuantos años tienes?", "Pregunta 4.3 - Niño o niña?", "Pregunta 4.4 - negro o blanco?","Pregunta 4.5 - Que dia es hoy?" });

    }

    @Override
    public void onUpdateReceived(@org.jetbrains.annotations.NotNull Update actualizacion) {
